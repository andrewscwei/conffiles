...
export ZSH="/Users/andrewscwei/.oh-my-zsh"

# zsh-nvm
export NVM_AUTO_USE="true"

# Set name of the theme to load. Optionally, if you set this to "random" it'll
# load a random theme each time that oh-my-zsh is loaded.
# See https://github.com/robbyrussell/oh-my-zsh/wiki/Themes
# ZSH_THEME=""

# Set list of themes to load Setting this variable when ZSH_THEME=random causes
# zsh to load the theme from this variable instead of looking in
# ~/.oh-my-zsh/themes/. An empty array has no effect.
